...
function Navbar() {
  ...
  return (
    <>
      ...
      >
        <div
          className={`"navbar__logo  relative my-auto hidden h-10  items-center  md:inline-block md:w-40 lg:flex  lg:pl-9 ${
        ...
        >
          ...
          <h4
            className={`'lg:block ml-2 mb-[3px] hidden w-max text-xl  font-semibold  lg:inline-block ${
        ...
        {position ? (
          ...
          <div className="nav__midSection left-0 hidden w-[100%] pt-2 text-white md:absolute md:top-[88px] md:block md:bg-black lg:relative lg:top-0 lg:bg-black lg:py-0">
            <div className="ml-auto  mr-auto flex justify-center md:w-[450px] lg:bg-black">
              <div
        ...
        >
          <h3
            className={`"cursor-pointer min-w-[150px] rounded-full px-4 py-3  hover:bg-white/[0.17] ${
              position ? 'text-black' : ''
            }`}
          >
            Become a Host
      ...
      >
        ...
        >
          ...
          <h3 className={`truncate text-black/[.6] `}>Where are you going?</h3>
        </div>
